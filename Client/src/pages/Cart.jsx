...
const Cart = () => {
  ...
  const getCart = () => {
    let tempArray = [];
    console.log(cartItems, "cart items from the get cart");

    for (const item of cartItems) {
      console.log(item.productId, "productId from cartItems");
    ...
    <div className="flex flex-col md:flex-row mt-16">
      <div className="flex-1 max-w-4xl">
        <h1 className="text-3xl font-medium mb-6">
          Shopping Cart <span className="text-sm text-primary"></span>
        </h1>
        ...
        {cartArray.map((product, index) => {
          const currentQuantity =
            cartItems.find((item) => item.productId === product._id)?.quantity || 1;
          return (
            <div
              key={index}
                ...
                <div>
                  ...
                  <div className="font-normal text-gray-500/70">
                    ...
                    <div className="flex items-center">
                      ...
                      >
                        {Array(currentQuantity > 9 ? currentQuantity : 9)
                          .fill("")
                          .map((_, index) => (
